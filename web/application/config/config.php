...
$script_name = isset($_SERVER['SCRIPT_NAME']) ? trim(str_replace('\\', '/', $_SERVER['SCRIPT_NAME']), '/') : '';
$base_segment = $script_name !== '' ? strtok($script_name, '/') : 'dashboard_subprocess';
$config['base_url'] = $protocol . '://' . $host . '/' . $base_segment . '/';
